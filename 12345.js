...
**************************************
[rewrite_local]
^http[s]?:\/\/((app|api|data|dataflow|*)\.(\w{2,15})?\.(com|cn)).*player\.(v3|v2|v1).Play(URL|View).*$ url script-request-header https://raw.githubusercontent.com/AndreDommond/qxx/master/12345.js
[mitm]
